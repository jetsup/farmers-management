    ...
    $(function () {
        ...
        if ($("#transaction-history").length) {
            ...
            fetch("/dashboard-admin-data")
                ...
                .then((data) => {
                    monthlyFarmersPayments = data.monthly_farmers_payments;
                    monthlyRevenue = data.monthly_revenue;
                    monthlyExpenses = data.monthly_expenses;

                    var areaData = {
                        labels: ["Farmers", "Revenue", "Expenses"],
                        datasets: [
                            {
                                data: [
                                    monthlyFarmersPayments,
                                    monthlyRevenue,
                                    monthlyExpenses,
                                ],
                                backgroundColor: [
                    ...
                    var transactionhistoryChartCanvas = $(
                        "#transaction-history"
                    )
                        .get(0)
                        .getContext("2d");
